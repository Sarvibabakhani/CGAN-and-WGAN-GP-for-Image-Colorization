...
class downsample_c(nn.Module): 
  ...
  def __init__(self, input_cha, output_cha, size, H, apply_batchnorm=True):
    super().__init__()
...
class critic(nn.Module):
   ...
   def __init__(self):
        ...
        self.l1 = downsample_c(3, 64, 4, 128, apply_batchnorm=False)  # (batch_size, 64, 128, 128)
        self.l2 = downsample_c(64, 128, 4, 64, apply_batchnorm=False)  # (batch_size, 128, 64, 64)
        self.l3 = downsample_c(128, 256, 4, 32, apply_batchnorm=False)  # (batch_size, 256, 32, 32)
        self.l4 = nn.ZeroPad2d(1) # (batch_size, 256, 34, 34)
        self.l5 =  nn.Sequential(
          nn.Conv2d(256, 512, 4, bias=False, stride=1),
          # nn.BatchNorm2d((512)),
          nn.LeakyReLU(0.2,True) )  # (batch_size, 512, 31, 31)
